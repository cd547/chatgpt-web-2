export default {
  ...
  home: {
    ...
    Me: 'About Me',
    Open: 'This project is open-sourced on ',
    Base: ', and is based on ',
    Come: '.',
    Relation: 'Due to the maintenance of website operations, this website may have charging or advertising behaviors that are unrelated to the program author.',
    Donate: 'Donate Here',
  },
}
