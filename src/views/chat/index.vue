        ...
        <template v-if="!dataSources.length">
          <div class="flex flex-col items-center text-sm">
            <div class="text-gray-800 w-full md:max-w-2xl lg:max-w-3xl md:h-full md:flex md:flex-col px-6 dark:text-gray-100">
              <h1 class="text-4xl font-semibold text-center mt-6 sm:mt-[20vh] ml-auto mr-auto mb-10 sm:mb-16 flex gap-2 items-center justify-center">The Wang</h1>
          ...
          <div class="text-center mt-12">
            ...
            <p class="mt-4 text-center w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md">
              ...
              <br>
              <a href="https://donate.thew.top/" class="text-blue-600 dark:text-blue-500 text-center" target="_blank" rel="noopener noreferrer">{{ $t('home.Donate') }}</a>
            </p>
          </div>
        </div>
      </div>
